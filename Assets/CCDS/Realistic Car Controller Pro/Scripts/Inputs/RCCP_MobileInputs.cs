...
public class RCCP_MobileInputs : RCCP_GenericComponent {
    ...
    private void Update() {
        ...
        if (RCCSceneManager && RCCSceneManager.activePlayerVehicle) {

            if (RCCSceneManager.activePlayerVehicle.OtherAddonsManager && RCCSceneManager.activePlayerVehicle.OtherAddonsManager.Nos) {
