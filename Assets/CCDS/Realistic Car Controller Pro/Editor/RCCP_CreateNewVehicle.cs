...
public class RCCP_CreateNewVehicle {
    ...
    public static RCCP_CarController NewVehicle(GameObject vehicle) {
        ...
        int answer2 = EditorUtility.DisplayDialogComplex("Adding CCDS_Player", "Is this vehicle will be a player vehicle or an AI vehicle?", "Player Vehicle", "Idk", "AI Vehicle");

        if (answer2 == 0) {

            if (!newVehicle.TryGetComponent(out CCDS_Player player))
